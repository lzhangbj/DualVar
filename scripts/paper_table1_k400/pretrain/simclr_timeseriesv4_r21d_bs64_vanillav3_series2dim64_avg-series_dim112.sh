...
python3 -m torch.distributed.launch --nproc_per_node=8 \
  ...
  --model simclr_timeseriesv4 --aug_same_series --use_series_contrast --series_mode avg-series --n_series 2 --series_dim 64 --series_T 0.5 \
  --net r21d --series_method v3 \
  --moco-t 0.07 \
  --ft_mode \
  --dataset k400-2clip-stage-prototype --ds 4 -j 8 \
  ...
  --print_freq 200 --eval_freq 1 --save_freq 1 \
