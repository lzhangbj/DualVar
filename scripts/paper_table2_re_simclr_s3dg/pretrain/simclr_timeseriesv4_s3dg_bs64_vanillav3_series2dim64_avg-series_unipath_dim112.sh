...
python3 -m torch.distributed.launch --nproc_per_node=8 \
  ...
  --model simclr_timeseriesv4 --aug_same_series --use_series_contrast --series_mode avg-series --n_series 2 --series_dim 64 --series_T 0.5 --unipath \
  --net s3dg --series_method v3 \
  --moco-t 0.07 \
  --ft_mode \
